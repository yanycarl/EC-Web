...
<center>
<strong><font size="+2">选择充值金额</font></strong><hr size="6" noshade>
<form method="post" action="chargeTable.asp">
<font size="+3">金额:</font>
<input name="balance" type="text">

<p>
<input name="ok" type="submit" value="确认">
<input name="cancel" type="reset" value="清零">
</p>
</form>
<a href="personal.asp">返回个人页面</a>
</center>
