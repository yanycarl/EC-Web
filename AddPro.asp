...
<center>
<strong><font size="+2">商品信息注册表</font></strong><hr size="6" noshade>
<form method="post" action="registerPro.asp">
...
<p>
<font size="+3">图片名:</font>
<input name="pic" type="text">
</p>
<p>
<font size="+3">原产地:</font>
<input name="country" type="text">
</p>
<p>
<input name="ok" type="submit" value="提交添加">
<input name="cancel" type="reset" value="重置数据">
</p>
</form>
<a href="AdminInfo.html">返回管理员页面</a>
</center>
