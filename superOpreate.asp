...
p.NewStyle26{
mso-style-name:"HTML 预设格式 Char Char Char";
margin-top:0.0000pt;
margin-right:0.0000pt;
margin-bottom:0.0000pt;
margin-left:0.0000pt;
...
div.Section0{page:Section0;}</style></head><body style="tab-interval:21pt; text-justify-trim:punctuation; " ><!--StartFragment--><div class="Section0"  style="layout-grid:15.6000pt; " ><p class=MsoNormal  style="background:rgb(156,194,229);" ><span style="mso-spacerun:'yes';font-family:Calibri;mso-fareast-font-family:宋体;mso-bidi-font-family:'Times New Roman';font-size:10.5000pt;mso-font-kerning:1.0000pt;background:rgb(156,194,229);mso-shading:rgb(156,194,229);" >&nbsp;</span><span style="mso-spacerun:'yes';font-family:Calibri;mso-fareast-font-family:宋体;mso-bidi-font-family:'Times New Roman';font-size:10.5000pt;mso-font-kerning:1.0000pt;background:rgb(156,194,229);mso-shading:rgb(156,194,229);" ><o:p></o:p></span></p><p class=MsoNormal  style="background:rgb(156,194,229);" ><span style="mso-spacerun:'yes';font-family:Calibri;mso-fareast-font-family:宋体;mso-bidi-font-family:'Times New Roman';font-size:10.5000pt;mso-font-kerning:1.0000pt;background:rgb(156,194,229);mso-shading:rgb(156,194,229);" >&nbsp;</span><span style="mso-spacerun:'yes';font-family:Calibri;mso-fareast-font-family:宋体;mso-bidi-font-family:'Times New Roman';font-size:10.5000pt;mso-font-kerning:1.0000pt;background:rgb(156,194,229);mso-shading:rgb(156,194,229);" ><o:p></o:p></span></p><p class=MsoNormal  style="background:rgb(156,194,229);" ><span><img width="744"  height="253"  src="personal.files/personal89.png" ></span><span style="mso-spacerun:'yes';font-family:Calibri;mso-fareast-font-family:宋体;mso-bidi-font-family:'Times New Roman';font-size:10.5000pt;mso-font-kerning:1.0000pt;background:rgb(156,194,229);mso-shading:rgb(156,194,229);" ><o:p></o:p></span></p><p class=MsoNormal  style="background:rgb(156,194,229);" ><span style="mso-spacerun:'yes';font-family:Calibri;mso-fareast-font-family:宋体;mso-bidi-font-family:'Times New Roman';font-size:10.5000pt;mso-font-kerning:1.0000pt;background:rgb(156,194,229);mso-shading:rgb(156,194,229);" ><o:p>&nbsp;</o:p></span></p></div><!--EndFragment-->

<center>
<br><a href="AdminInfo.asp">返回超级管理员信息界面</a></br>

<br><a href="default.html">返回首页</a></br>
<br>
<span style="font-weight:bold;">超级管理员操作</span>
</br>
<font size="+3">需要查询的用户ID:</font>
<%
    response.write("<center><form method="&"post"&" action="&"QueryResult.asp"&">")
    response.write("<br><input name="&"op"&" type="&"username >")
    response.write("<input name="&"ok"&" type="&"submit"&" value="&"执行操作"&">")
    response.write("</center></form><br>")

%>

<font size="+3">或者输入订单数据库查询语句:</font>
<%
    response.write("<center><form method="&"post"&" action="&"QueryResult2.asp"&">")
    response.write("<br><input name="&"op"&" type="&"username >")
    response.write("<input name="&"ok"&" type="&"submit"&" value="&"执行操作"&">")
    response.write("</center></form><br>")
...
<br><a href="AddPro.asp">添加商品</a></br>
</center>