...
rs2.Source ="select * from [admin$] where uid='"&request.cookies("guango")("id")&"'" '设置查询语句
rs2.Open()


response.write("<br><span style="&"font-weight:bold;"&">欢迎你，以下是你的个人资料:</span></br><br></br>")
...
response.write("<br>")
response.write("常用地址："+rs2("addr"))
response.write("<br>")
response.write("性别："+rs2("sex"))
response.write("<br>")
response.write("地区："+rs2("region"))
response.write("<br>")
response.write("电话："+rs2("tel"))
response.write("<br>")
response.write("Email："+rs2("email"))
response.write("<br>")
response.write("<br>") '将结果写到屏幕上
...
%>
<a href="superOpreate.asp">数据库操作</a>
<br><a href="default.html">返回首页，退出登录</a></br>
</center>
</body></html>